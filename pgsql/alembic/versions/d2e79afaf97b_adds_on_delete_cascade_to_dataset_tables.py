...
def schema_upgrades():
    ...
    try:
        op.drop_constraint('fk_dataset_to_datapoints_dataset_datasets', 'dataset_to_datapoints', type_='foreignkey')
        op.drop_constraint('fk_dataset_to_datapoints_datapoint_datapoints', 'dataset_to_datapoints', type_='foreignkey')
    except:
        pass
